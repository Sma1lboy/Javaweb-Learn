package me.jackson.pro10fruitthymeleaf.fruit.dao.impl;

import me.jackson.pro10fruitthymeleaf.fruit.dao.FruitDAO;
import me.jackson.pro10fruitthymeleaf.fruit.dao.base.BaseDAO;
...
public class FruitDAOImpl extends BaseDAO<Fruit> implements FruitDAO {
    ...
    public List<Fruit> getFruitList() {
        return super.executeQuery("select fruit_id id, name, price, stock, comment from fruit order by fruit_id");
    }
