package me.jackson.pro21qqzone1.myssm.ioc;
...
//        FileInputStream is = new FileInputStream("./src/main/resources/applicationContext.xml");
...
//    }
    ...
    public ClassPathXmlApplicationContext(){
        ...
        //
        try {
//            InputStream resourceAsStream = this.getClass().getResourceAsStream("/applicationContext.xml");
            String resource =  Objects.requireNonNull(this.getClass().getResource("/applicationContext.xml")).getPath();
